...
# Predefined memory prompts for seniors
MEMORY_PROMPTS = [
    {"id": 1, "category": "Family", "prompt": "Tell me about your wedding day. What do you remember most?"},
    ...
    {"id": 4, "category": "Work", "prompt": "What kind of work did you do? What was a typical day like?"},
    {"id": 5, "category": "Home", "prompt": "Describe the house you grew up in. What was your favorite room?"},
    {"id": 6, "category": "Friends", "prompt": "Tell me about your best friend. How did you meet?"},
    {"id": 7, "category": "Holidays", "prompt": "What was your favorite holiday? How did your family celebrate?"},
    ...
    {"id": 15, "category": "Neighbors", "prompt": "Tell me about the neighborhood where you lived. Who were your neighbors?"}
]
